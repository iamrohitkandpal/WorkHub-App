  ...
  return (
    <div>
        <footer className='border-t border-t-gray-200 py-8'>
            <div className='constainer mx-auto px-24'>
                <div className='flex flex-col md:flex-row justify-between items-center'>
                    <div className='mb-4 md:mb-0'>
                        <h2 className='text-lg font-bold'>JobHub</h2>
                        <p className='text-sm'>© 2024 Rohit Kandpal. All rights reserved.</p>
                    </div>

                    <div className="flex space-x-4 mt-4 md:mt-0">
                        <a href="https://github.com" className="hover:text-gray-400" aria-label="Facebook">
